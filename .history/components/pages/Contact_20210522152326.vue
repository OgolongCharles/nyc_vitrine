          ...
          <form action="#"  novalidate="true" class="contactFrom" id="contactForm">
            ...
            <div class="row">
              <div class="col-lg-6 col-sm-6">
                <input class="input-form required" type="text"   placeholder="First Name" v-model="f_name">
              </div>
              <div class="col-lg-6 col-sm-6">
                <input class="input-form required" type="text" n  placeholder="Last Name" v-model="l_name">
              </div>
              <div class="col-lg-6 col-sm-6">
                <input class="input-form required" type="email"  placeholder="Email Address" v-model="email">
              </div>
              <div class="col-lg-6 col-sm-6">
                <input class="input-form" type="text"  placeholder="Phone Number" v-model="phone">
              </div>
              <div class="col-lg-12 col-sm-12">
                <textarea class="input-form required"  placeholder="Write Message" v-model="description"></textarea>
              </div>
            </div>
