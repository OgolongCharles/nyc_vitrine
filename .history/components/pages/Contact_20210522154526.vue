    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
          <h4 class="sub_title">{{$t("contact:"Nous Contacter",")}}</h4>
          <h2 class="sec_title">{{$t("messageUs")}}</h2>
        ...
        <div class="col-lg-8 col-lg-offset-2 col-sm-12 col-md-10 col-md-offset-1">
          <form action="#"  novalidate="true" class="contactFrom" id="contactForm">
            ...
            <div class="row">
              ...
              <div class="col-lg-6 col-sm-6">
                <input class="input-form required" type="text"  :placeholder= '$t("Second")'  v-model="l_name">
              </div>
              <div class="col-lg-6 col-sm-6">
                <input class="input-form required" type="email"  placeholder="Email" v-model="email">
              </div>
              <div class="col-lg-6 col-sm-6">
                <input class="input-form" type="text"  :placeholder= '$t("phoneNumber")'  v-model="phone">
              </div>
